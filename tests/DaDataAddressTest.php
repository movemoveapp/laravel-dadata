...
class DaDataAddressTest extends TestCase
{
    ...
    /**
     * @test
     * @dataProvider StandardizationAddressProvider
     **/
    public function testStandardizationAddressFromString($query, $response)
    {
        $data = DaDataAddress::standardization($query);
